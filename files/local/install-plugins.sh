...
wget --no-verbose "https://github.com/tulibraries/centerrow-temple/archive/refs/tags/v0.2.zip" -O centerrow-temple.zip && unzip -o centerrow-temple.zip -d /var/www/html/themes/ && rm centerrow-temple.zip 
